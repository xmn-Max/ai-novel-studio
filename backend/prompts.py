...
GENRE_GUIDANCE = {
    "武侠": "这是一部武侠小说。请重点关注江湖纷争、武打场面、侠客形象和正邪对抗。主角候选优先考虑侠客、掌门或独行武者。",
    "玄幻": "这是一部玄幻小说。请重点关注修炼体系、冒险历程、天才成长和法宝功法。主角候选优先考虑修炼者、天才少年或转世强者。",
    "科幻": "这是一部科幻小说。请重点关注科技设定、未来世界、科学探索和文明冲突。主角候选优先考虑科学家、探险者或AI/改造人。",
    "言情": "这是一部言情小说。请重点关注情感关系、人物互动、感情起伏和关系转折。主角候选优先考虑情侣双方或主要情感人物。",
    "叙事": "这是一部叙事小说。请重点关注故事结构、人物心理、社会关系和命运转折。主角候选优先考虑故事核心人物或视角人物。",
    "魔幻": "这是一部魔幻小说。请重点关注魔法体系、奇异事件、英雄使命和善恶对决。主角候选优先考虑魔法师、英雄或预言之人。",
}
